...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article style24">
          <h2 class="style23">View All End Users!! </h2>
          <div class="clr"></div>
          <div class="details">
            <div align="justify">
              <p>&nbsp;</p>
              <table width="602" border="1" align="center">
                <tr>
                  <td width="104" height="31"><div align="center" class="style25">Owner ID </div></td>
                  <td width="124"><div align="center" class="style25">Owner Name </div></td>
                  <td width="108"><div align="center" class="style25">EMail</div></td>
                  <td width="171"><div align="center" class="style25">Mobile </div></td>
                  <td width="110"><div align="center" class="style25">Address</div></td>
				  <td width="110"><div align="center" class="style25">DOB</div></td>
				   <td width="110"><div align="center" class="style25">Gender</div></td>
                </tr>
                <%
