...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Files Without Secret Key !! </span></h2>
          <div class="clr"></div>
          <div class="details">
            <div align="justify">
              <p>&nbsp;</p>
              <table width="584" border="1" align="left">
                <tr>
                  <td width="78" height="30"><div align="center" class="style21"><span class="style23">User ID </span></div></td>
                  <td width="126"><div align="center" class="style21"><span class="style23">User Name </span></div></td>
                  <td width="126"><div align="center" class="style21"><span class="style23">Owner Name </span></div></td>
                  <td width="117"><div align="center" class="style21"><span class="style23">File Name </span></div></td>
                  <td width="205"><div align="center" class="style21"><span class="style23">Secret Key </span></div></td>
                  <%	  
	...
	int i=0,j=0,k=0;
      	...
      	try 
	{
        	String s="Generate Key";
			String strr="null";
      		String query="select * from request where sk='"+s+"' and sk='"+strr+"'"; 
...
%>
              ...
              <p>&nbsp;</p>
              <p>&nbsp;</p>
              <p><a href="StorageCSPMain.jsp">Back</a></p>
              <p><a href="index.html" class="style9"></a></p>
            </div></div>
          <p align="justify">&nbsp;</p>
        </div>
      </div>
