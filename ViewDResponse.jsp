      ...
      <div class="mainbar">
        <div class="article">
          ...
          <form id="form" name="form1" method="post" action="finddk.jsp">
            ...
            <p align="center" class="style19">Decrypt Permission Response : <%=application.getAttribute("key")%>&nbsp;</p>
          </form>
