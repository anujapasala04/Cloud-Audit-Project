...
<head>
<title>Central Authority Main :: Secure Data Group Sharing</title>
...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          <li ><a href="TrustedAuthorityMain.jsp">Home</a></li>
            <li><a href="DataUserLogin.jsp">Data User </a></li>
            <li><a href="DataOwnerLogin.jsp">Data Owner </a></li>
            <li class="active"><a href="TrustedAuthorityLogin">Central Authority</a></li>
    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="TrustedAuthorityMain.jsp">Home</a></li>
            <li><a href="ViewMetadata.jsp">View MetaData Of All Files </a></li>
            <li><a href="ViewTrapAttackers.jsp">View All Trapdoor Attacker </a></li>
            <li><a href="ViewSecretAttackers.jsp">View All SecretKey Attacker </a></li>
            <li><a href="TrustedAuthorityLogin.jsp">Logout</a></li>
          </ul>
        </div>
      </div>
      <div class="clr"></div>
