<title>Enduser Registration authen</title>
...
<%
					...
					if ( rs1.next() )
					   {
							...
							response.sendRedirect("DnameExist.html");
							%>
							<p><a href="DataOwnerRegister.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
					   PreparedStatement ps=connection.prepareStatement("insert into downer(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,gname) values(?,?,?,?,?,?,?,?,?,?,?)");
				...
				//		ps.setString(11,sk);		
						...
						if(x>0){
							response.sendRedirect("Registeredsuccess.html");
