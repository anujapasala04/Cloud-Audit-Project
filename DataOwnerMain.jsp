...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome ::<%=application.getAttribute("dname")%>:</span></h2><br>
		  <h2><span>Your Group ::<%=application.getAttribute("gname1")%>:</span></h2>
          <div class="clr"></div>
          <div class="details">
            <div align="justify">
