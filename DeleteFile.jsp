...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Delete File  :</span></h2>
          <div class="clr"></div>
          <div class="details">
            <div align="justify">
                <span class="style10">
                <label for="name"><br /></label></span>
                <table width="591" border="1" align="center">
                  <tr>
                    ...
                    <td width="144"><div align="center" class="style26"><span class="style25">Uploaded Date</span> &amp; Time </div></td>
                    <td width="176"><div align="center" class="style21"><span class="style23">Data Owner </span></div></td>
                    <td width="176"><div align="center" class="style21"><span class="style23">Delete File </span></div></td>
                    <%	  
...
try 
	{
			...
			while ( rs.next() )
			{
					...
					String dt = new String(Base64.decode(s3.getBytes()));
						...
						<td><div>
						<div align="center"><a href="Delete.jsp?usid=<%=i%>">Delete</a></div>
						</div></td>
...
%>
              ...
              <p class="style7">
                ...
                <%=application.getAttribute("msg")%></div>
		  </div>
          <p align="justify">&nbsp;</p>
        </div>
      </div>
