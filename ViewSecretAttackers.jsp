...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Secret Key Attackers  : </span></h2>
          <div class="clr"></div>
          <div class="details">
            <div align="justify">
              <p>&nbsp;</p>
              <table width="602" border="1" align="center">
                <tr>
                  ...
                  <td width="171"><div align="center" class="style22">Attack Type </div></td>
      	...
      	try 
	{
      		...
      		String query="select * from attacker where attacktype='"+type+"' "; 
...
%>
              ...
              <p>&nbsp;</p>
              <p><a href="TrustedAuthorityMain.jsp">Back</a></p>
              <p>&nbsp;</p>
              <p class="style7">
