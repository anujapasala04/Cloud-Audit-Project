...
<div class="main">
      ...
      <div class="menu_nav">
        <ul>
          <li ><a href="index.html">Home</a></li>
            ...
            <li class="active"><a href="TrustedAuthorityLogin.jsp">Central Authority</a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Central Authority Login : </span></h2>
          <div class="clr"></div>
          <div class="details">
            <div align="justify">
              <form action="TAAuthentication.jsp" method="post" id="leavereply">
                <label for="name"><br />
                  Central Authority Name (required)<br />
                </label>
