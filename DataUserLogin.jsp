    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <form action="DUAuthentication.jsp" method="post" id="leavereply">
            <label for="name"><br />
              Name (required)<br />
            </label>
            ...
            <p>New user ? click here to <a href="DataUserRegister.jsp"> Register</a></p>
          </form>
          <p align="justify"><a href="index.html" class="style9">Back</a></p>
        </div>
      </div>
      <div class="sidebar">
