...
<head>
<title>Cloud Service Provider Main</title>
...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>Welcome Storage   Cloud Service Provider !! </span></h2>
          <div class="clr"></div>
          <div class="details">
            <div align="justify">
              <p><img src="images/img1.jpg" width="527" height="291" />              </p>
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
			...
			<li><a href="ViewDataOwners.jsp">View All Data Owners </a></li>
			<li><a href="ViewEndUsers.jsp">View All Endusers </a></li>
