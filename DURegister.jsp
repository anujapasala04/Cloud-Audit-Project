					...
					if ( rs1.next() )
					   {
							...
							response.sendRedirect("DUnameExist.html");
							%>
							<p><a href="DataUserRegister.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
							PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,pin,location,imagess,gname) values(?,?,?,?,?,?,?,?,?,?,?)");
